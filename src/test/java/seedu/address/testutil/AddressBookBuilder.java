...
public class AddressBookBuilder {
    ...
    /**
     * Adds a new {@code Pair} to the {@code AddressBook} that we are building.
     */
    public AddressBookBuilder withPair(Pair pair) {
        try {
            addressBook.addPair(pair);
        } catch (DuplicatePairException dpe) {
            throw new IllegalArgumentException("pair is expected to be unique.");
        }
        return this;
    }
