...
----
[NOTE]
As shown from this code snippet, any tag that is not set to one of the 4 attributes will fall through to the default type, where they will have the same color. This is done to prevent accidental collisions of color with the 4 attribute tags.
