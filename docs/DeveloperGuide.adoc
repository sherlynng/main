...
|NG Xin Ler |Change browser panel to view Person's details and remove all attributes except tags in
...
|WANG Zi |Create shortcut for the user in filling subject, level, status and role. For instance, `sub/eng` and `sub/english` both result in adding the subject English.
