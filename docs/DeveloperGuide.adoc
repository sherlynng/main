...
==== Current Implementation
We made input of all fields case insensitive to reduce hassles for the user.
...
All the fields utilise the `ProperCaseConverter` object in similar way.
...
----
[NOTE]
The user can input short-cut in case insensitive fashion.
