...
image::RemarkCommandSequenceDiagram.png[width="350"]
.Sequence Diagram for `remark`

image::RemarkCommandSequenceDiagram1.png[width="350"]
...
image::RateCommandSequenceDiagram.png[width="350"]
.Sequence Diagram for `rate`

image::RateCommandSequenceDiagram1.png[width="350"]
