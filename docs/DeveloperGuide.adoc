...
The `Tag` class has been changed to support the ability to classify which attribute the tag was created from. This is done by adding an enum `allTagsType` to the `Tag` class.
