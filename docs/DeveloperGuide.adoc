...
The image below shows the modifications made:

image::BrowserPanelModifications.png[width="800"]

===== Current Implementation
The UI is modified using SceneBuilder and the layout is specified in link:{repoURL}/main/blob/master/src/main/resources/view/BrowserPanel.fxml[`BrowserPanel.fxml`].
link:{repoURL}/main/blob/master/src/main/java/seedu/address/ui/BrowserPanel.java[`BrowserPanel.java`] subscribes to `handlePersonPanelSelectionChangedEvent`, where this allows the browser panel to
...
The image below shows the improvements made:

image::PersonCardModifications.png[width="800"]

===== Aspect: Removal of Unncessary Information
