...
STUtor -V1.5 is a desktop address book targeting tuition coordinators
...
** Documentation:
*** Creaate UI mock up for initial planning of UI (Pull requests https://github.com/CS2103JAN2018-W11-B1/main/pull/26[#26])
