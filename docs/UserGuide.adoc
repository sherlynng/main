...
The user can then mark the person with one of the choices.
*  If the user cannot confirm the match yet but wishes to take note of a potential match,
he/she can mark the pair as `Matching in Progress`.

** Display of pair information
*  The user will be able to view the schedule and billing information of the pair.
...
==== Enterprise Version of STUtor `[Coming in V2.0]`
...
*  Real-time syncing will allow multiple coordinators will be able to work on the same database.
