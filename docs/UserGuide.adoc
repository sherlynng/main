...
You can also reverses the most recent `*undo*` command. +
Format: `*redo*`
...
Then, navigate to main/data, and overwrite the empty  `STUtor.xml` file it creates with your previous file.
You can can find the previous file under the same path on your original computer.
