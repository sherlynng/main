...
A person can have the following fields: SUBJECT, EDUCATION_LEVEL, PRICE, ROLE, and STATUS.

[width="80%",cols="<20%,<20%,<20%,<20%",options="header",]
|=======================================================================
|Field |Options |Field Editable by User |Comment
|subject | English, Chinese,  Math, Chemistry, Physics| Yes |
|level | Lower Primary, Upper Primary, Lower Secondary, Upper Secondary| Yes|
|price | Must be a positive number| Yes |
|role | Student, Tutor| Yes |
|status| Matched, Not Matched | No | Upon adding to STUtor, all persons will have a default status of "Not Matched"
|=======================================================================
****
